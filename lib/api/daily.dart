...
class CurrentRotation {
  ...
  factory CurrentRotation.fromJson(Map<String, dynamic> json) =>
      CurrentRotation();
...
class Shop {
  ...
  factory Shop.fromJson(Map<String, dynamic> json) => Shop(
        ...
        displayAssets: List<DisplayAsset>.from(
            json["displayAssets"].map((x) => DisplayAsset.fromJson(x))),
        firstReleaseDate: DateTime.parse(json["firstReleaseDate"]),
        previousReleaseDate: json["previousReleaseDate"] == null
            ? null
            : DateTime.parse(json["previousReleaseDate"]),
        ...
        granted:
            List<Granted>.from(json["granted"].map((x) => Granted.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "offerId": offerId,
        "displayAssets":
            List<dynamic>.from(displayAssets.map((x) => x.toJson())),
        "firstReleaseDate":
            "${firstReleaseDate.year.toString().padLeft(4, '0')}-${firstReleaseDate.month.toString().padLeft(2, '0')}-${firstReleaseDate.day.toString().padLeft(2, '0')}",
        "previousReleaseDate": previousReleaseDate == null
            ? null
            : "${previousReleaseDate.year.toString().padLeft(4, '0')}-${previousReleaseDate.month.toString().padLeft(2, '0')}-${previousReleaseDate.day.toString().padLeft(2, '0')}",
